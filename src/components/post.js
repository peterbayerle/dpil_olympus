    ...
    return (
      <div 
        ...
        className={this.postClasses}>
          ...
          <Card>
            <Card.Header>
              <img className="rounded-circle profilePicture" src={"https://raw.githubusercontent.com/peterbayerle/dpil_olympus/main/"+this.props.profile_picture} alt="profile"></img> 
